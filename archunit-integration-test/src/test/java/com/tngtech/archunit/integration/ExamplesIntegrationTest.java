...
class ExamplesIntegrationTest {
    ...
    Stream<DynamicTest> LayerDependencyRulesTest() {
        return ExpectedTestFailures
                ...
                .by(method(ServiceHelper.class, "violatingLayerRuleByMethodTypeParameters")
                        .withTypeParameter("METHOD_TYPE_PARAMETER_VIOLATING_LAYER_RULE").dependingOn(SomeUtility.class))
                .by(method(ServiceHelper.class, "violatingLayerRuleByMethodTypeParameters")
                        .withTypeParameter("ANOTHER_METHOD_TYPE_PARAMETER_VIOLATING_LAYER_RULE").dependingOn(SomeEnum.class))
